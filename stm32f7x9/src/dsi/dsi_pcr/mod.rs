...
impl W {
    ...
    #[doc = "Bit 0 - EoTp Transmission Enable"]
    #[inline]
    pub fn ettxe(&mut self) -> _ETTXEW {
        _ETTXEW { w: self }
    }
    #[doc = "Bit 1 - EoTp Reception Enable"]
    #[inline]
    pub fn etrxe(&mut self) -> _ETRXEW {
        _ETRXEW { w: self }
    }
    #[doc = "Bit 2 - Bus Turn Around Enable"]
    #[inline]
    pub fn btae(&mut self) -> _BTAEW {
        _BTAEW { w: self }
    }
    #[doc = "Bit 3 - ECC Reception Enable"]
    #[inline]
    pub fn eccrxe(&mut self) -> _ECCRXEW {
        _ECCRXEW { w: self }
    }
    #[doc = "Bit 4 - CRC Reception Enable"]
    #[inline]
    pub fn crcrxe(&mut self) -> _CRCRXEW {
        _CRCRXEW { w: self }
    }
}
