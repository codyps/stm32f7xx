...
impl W {
    ...
    #[doc = "Bit 0 - Clear the preamble error flag"]
    #[inline]
    pub fn cperf(&mut self) -> _CPERFW {
        _CPERFW { w: self }
    }
    #[doc = "Bit 1 - Clear the start error flag"]
    #[inline]
    pub fn cserf(&mut self) -> _CSERFW {
        _CSERFW { w: self }
    }
    #[doc = "Bit 2 - Clear the turnaround error flag"]
    #[inline]
    pub fn cterf(&mut self) -> _CTERFW {
        _CTERFW { w: self }
    }
}
