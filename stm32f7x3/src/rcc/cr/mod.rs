...
#[doc = r" Proxy"]
pub struct _PLLSAIRDYW<'a> {
    w: &'a mut W,
}
impl<'a> _PLLSAIRDYW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl R {
    ...
    #[inline]
    pub fn pllsairdy(&self) -> PLLSAIRDYR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 29;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
    pub fn pllsaion(&self) -> PLLSAIONR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 28;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
impl W {
    ...
    #[doc = "Bit 29 - PLLSAI clock ready flag"]
    #[inline]
    pub fn pllsairdy(&mut self) -> _PLLSAIRDYW {
        _PLLSAIRDYW { w: self }
    }
    #[doc = "Bit 28 - PLLSAI enable"]
    #[inline]
    pub fn pllsaion(&mut self) -> _PLLSAIONW {
        _PLLSAIONW { w: self }
    }
}
