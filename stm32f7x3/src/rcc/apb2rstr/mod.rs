...
#[doc = r" Proxy"]
pub struct _SDMMC2RSTW<'a> {
    w: &'a mut W,
}
impl<'a> _SDMMC2RSTW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
#[doc = r" Proxy"]
pub struct _USBPHYCRSTW<'a> {
    w: &'a mut W,
}
impl<'a> _USBPHYCRSTW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl R {
    ...
    #[doc = "Bit 31 - USB OTG HS PHY controller reset"]
    #[inline]
    pub fn usbphycrst(&self) -> USBPHYCRSTR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 31;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
impl W {
    ...
    #[doc = "Bit 7 - SDMMC2 reset"]
    #[inline]
    pub fn sdmmc2rst(&mut self) -> _SDMMC2RSTW {
        _SDMMC2RSTW { w: self }
    }
    #[doc = "Bit 31 - USB OTG HS PHY controller reset"]
    #[inline]
    pub fn usbphycrst(&mut self) -> _USBPHYCRSTW {
        _USBPHYCRSTW { w: self }
    }
}
