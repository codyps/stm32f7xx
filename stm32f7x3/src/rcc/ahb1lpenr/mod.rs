...
impl R {
    ...
    #[doc = "Bit 13 - AXI to AHB bridge clock enable during Sleep mode"]
    #[inline]
    pub fn axilpen(&self) -> AXILPENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 13;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[doc = "Bit 20 - DTCM RAM interface clock enable during Sleep mode"]
    #[inline]
    pub fn dtcmlpen(&self) -> DTCMLPENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 20;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
impl W {
    ...
    #[doc = "Bit 13 - AXI to AHB bridge clock enable during Sleep mode"]
    #[inline]
    pub fn axilpen(&mut self) -> _AXILPENW {
        _AXILPENW { w: self }
    }
    #[doc = "Bit 20 - DTCM RAM interface clock enable during Sleep mode"]
    #[inline]
    pub fn dtcmlpen(&mut self) -> _DTCMLPENW {
        _DTCMLPENW { w: self }
    }
}
