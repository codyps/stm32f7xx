...
#[doc = r" Proxy"]
pub struct _SDMMC2LPENW<'a> {
    w: &'a mut W,
}
impl<'a> _SDMMC2LPENW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl R {
    ...
    #[doc = "Bit 7 - SDMMC2 clock enable during Sleep mode"]
    #[inline]
...
impl W {
    ...
    #[doc = "Bit 7 - SDMMC2 clock enable during Sleep mode"]
    #[inline]
    pub fn sdmmc2lpen(&mut self) -> _SDMMC2LPENW {
        _SDMMC2LPENW { w: self }
    }
}
