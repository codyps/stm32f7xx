...
#[doc = r" Proxy"]
pub struct _USBPHYCENW<'a> {
    w: &'a mut W,
}
impl<'a> _USBPHYCENW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl R {
    ...
    #[doc = "Bit 31 - USB OTG HS PHY controller clock enable"]
    #[inline]
    pub fn usbphycen(&self) -> USBPHYCENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 31;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
impl W {
    ...
    #[doc = "Bit 7 - SDMMC2 clock enable"]
    #[inline]
    pub fn sdmmc2en(&mut self) -> _SDMMC2ENW {
        _SDMMC2ENW { w: self }
    }
    #[doc = "Bit 31 - USB OTG HS PHY controller clock enable"]
    #[inline]
    pub fn usbphycen(&mut self) -> _USBPHYCENW {
        _USBPHYCENW { w: self }
    }
}
