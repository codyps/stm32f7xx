...
#[doc = r" Proxy"]
pub struct _MUTEDETIEW<'a> {
    w: &'a mut W,
}
impl<'a> _MUTEDETIEW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl W {
    ...
    #[doc = "Bit 2 - Wrong clock configuration interrupt enable"]
    #[inline]
    pub fn wckcfgie(&mut self) -> _WCKCFGIEW {
        _WCKCFGIEW { w: self }
    }
    #[doc = "Bit 1 - Mute detection interrupt enable"]
    #[inline]
    pub fn mutedetie(&mut self) -> _MUTEDETIEW {
        _MUTEDETIEW { w: self }
    }
    #[doc = "Bit 0 - Overrun/underrun interrupt enable"]
    #[inline]
