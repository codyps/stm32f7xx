...
impl W {
    ...
    #[inline]
    pub fn clfsdet(&mut self) -> _CLFSDETW {
        _CLFSDETW { w: self }
    }
    ...
    #[inline]
    pub fn ccnrdy(&mut self) -> _CCNRDYW {
        _CCNRDYW { w: self }
    }
    #[doc = "Bit 2 - Clear wrong clock configuration flag"]
    #[inline]
    pub fn cwckcfg(&mut self) -> _CWCKCFGW {
        _CWCKCFGW { w: self }
    }
    #[doc = "Bit 1 - Mute detection flag"]
    #[inline]
    pub fn cmutedet(&mut self) -> _CMUTEDETW {
        _CMUTEDETW { w: self }
    }
    #[doc = "Bit 0 - Clear overrun / underrun"]
    #[inline]
    pub fn covrudr(&mut self) -> _COVRUDRW {
        _COVRUDRW { w: self }
    }
}
