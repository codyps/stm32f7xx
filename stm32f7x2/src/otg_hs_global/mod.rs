...
pub struct RegisterBlock {
    ...
    pub otg_hs_hnptxfsiz_host: OTG_HS_HNPTXFSIZ_HOST,
    #[doc = "0x2c - OTG_HS nonperiodic transmit FIFO/queue status register"]
    pub otg_hs_hnptxsts: OTG_HS_HNPTXSTS,
    #[doc = "0x30 - OTG I2C access register"]
    pub otg_hs_gi2cctl: OTG_HS_GI2CCTL,
