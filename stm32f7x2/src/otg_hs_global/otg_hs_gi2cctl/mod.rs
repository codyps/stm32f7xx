...
#[doc = r" Proxy"]
pub struct _I2CDATSE0W<'a> {
    w: &'a mut W,
}
impl<'a> _I2CDATSE0W<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
#[doc = r" Proxy"]
pub struct _I2CDEVADRW<'a> {
    w: &'a mut W,
}
impl<'a> _I2CDEVADRW<'a> {
    #[doc = r" Writes raw bits to the field"]
    #[inline]
...
impl W {
    ...
    #[doc = "Bit 31 - I2C Busy/Done"]
    #[inline]
    pub fn bsydne(&mut self) -> _BSYDNEW {
        _BSYDNEW { w: self }
    }
    #[doc = "Bit 30 - Read/Write Indicator"]
    #[inline]
    ...
    #[doc = "Bit 28 - I2C DatSe0 USB mode"]
    #[inline]
    pub fn i2cdatse0(&mut self) -> _I2CDATSE0W {
        _I2CDATSE0W { w: self }
    }
    #[doc = "Bits 26:27 - I2C Device Address"]
    #[inline]
    pub fn i2cdevadr(&mut self) -> _I2CDEVADRW {
        _I2CDEVADRW { w: self }
    }
    #[doc = "Bit 24 - I2C ACK"]
    #[inline]
    ...
    #[doc = "Bits 0:7 - I2C Read/Write Data"]
    #[inline]
    pub fn rwdata(&mut self) -> _RWDATAW {
        _RWDATAW { w: self }
    }
}
