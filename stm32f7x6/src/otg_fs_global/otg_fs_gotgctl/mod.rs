...
#[doc = r" Proxy"]
pub struct _VBVALOVALW<'a> {
    w: &'a mut W,
}
impl<'a> _VBVALOVALW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl W {
    ...
    #[doc = "Bit 2 - VBUS valid override enable"]
    #[inline]
    pub fn vbvaloen(&mut self) -> _VBVALOENW {
        _VBVALOENW { w: self }
    }
    #[doc = "Bit 3 - VBUS valid override value"]
    #[inline]
    pub fn vbvaloval(&mut self) -> _VBVALOVALW {
        _VBVALOVALW { w: self }
    }
    #[doc = "Bit 4 - A-peripheral session valid override enable"]
    #[inline]
    pub fn avaloen(&mut self) -> _AVALOENW {
        _AVALOENW { w: self }
    }
    #[doc = "Bit 5 - A-peripheral session valid override value"]
    #[inline]
    pub fn avaloval(&mut self) -> _AVALOVALW {
        _AVALOVALW { w: self }
    }
    #[doc = "Bit 6 - B-peripheral session valid override enable"]
    #[inline]
    pub fn bvaloen(&mut self) -> _BVALOENW {
        _BVALOENW { w: self }
    }
    #[doc = "Bit 7 - B-peripheral session valid override value"]
    #[inline]
    pub fn bvaloval(&mut self) -> _BVALOVALW {
        _BVALOVALW { w: self }
    }
    #[doc = "Bit 12 - Embedded host enable"]
    #[inline]
