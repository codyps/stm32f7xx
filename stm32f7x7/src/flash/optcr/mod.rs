...
#[doc = r" Proxy"]
pub struct _IWDG_STDBYW<'a> {
    w: &'a mut W,
}
impl<'a> _IWDG_STDBYW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
#[doc = r" Proxy"]
pub struct _IWDG_STOPW<'a> {
    w: &'a mut W,
}
impl<'a> _IWDG_STOPW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl W {
    ...
    #[doc = "Bit 5 - User option bytes"]
    #[inline]
    pub fn iwdg_sw(&mut self) -> _IWDG_SWW {
        _IWDG_SWW { w: self }
    }
    #[doc = "Bit 6 - User option bytes"]
    #[inline]
    ...
    #[doc = "Bit 28 - Dual Boot mode (valid only when nDBANK=0)"]
    #[inline]
    pub fn n_dboot(&mut self) -> _NDBOOTW {
        _NDBOOTW { w: self }
    }
    #[doc = "Bit 29 - Not dual bank mode"]
    #[inline]
    pub fn n_dbank(&mut self) -> _NDBANKW {
        _NDBANKW { w: self }
    }
    #[doc = "Bit 30 - Independent watchdog counter freeze in standby mode"]
    #[inline]
