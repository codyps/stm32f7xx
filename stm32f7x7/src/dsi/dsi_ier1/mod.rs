...
impl W {
    ...
    #[doc = "Bit 0 - Timeout High-Speed Transmission Interrupt Enable"]
    #[inline]
    pub fn tohstxie(&mut self) -> _TOHSTXIEW {
        _TOHSTXIEW { w: self }
    }
    #[doc = "Bit 1 - Timeout Low-Power Reception Interrupt Enable"]
    #[inline]
    pub fn tolprxie(&mut self) -> _TOLPRXIEW {
        _TOLPRXIEW { w: self }
    }
    #[doc = "Bit 2 - ECC Single-bit Error Interrupt Enable"]
    #[inline]
    pub fn eccseie(&mut self) -> _ECCSEIEW {
        _ECCSEIEW { w: self }
    }
    #[doc = "Bit 3 - ECC Multi-bit Error Interrupt Enable"]
    #[inline]
    pub fn eccmeie(&mut self) -> _ECCMEIEW {
        _ECCMEIEW { w: self }
    }
    #[doc = "Bit 4 - CRC Error Interrupt Enable"]
    #[inline]
    ...
    #[doc = "Bit 5 - Packet Size Error Interrupt Enable"]
    #[inline]
    pub fn pseie(&mut self) -> _PSEIEW {
        _PSEIEW { w: self }
    }
    #[doc = "Bit 6 - EoTp Error Interrupt Enable"]
    #[inline]
    pub fn eotpeie(&mut self) -> _EOTPEIEW {
        _EOTPEIEW { w: self }
    }
    #[doc = "Bit 7 - LTDC Payload Write Error Interrupt Enable"]
    #[inline]
    pub fn lpwreie(&mut self) -> _LPWREIEW {
        _LPWREIEW { w: self }
    }
    #[doc = "Bit 8 - Generic Command Write Error Interrupt Enable"]
    #[inline]
    pub fn gcwreie(&mut self) -> _GCWREIEW {
        _GCWREIEW { w: self }
    }
    #[doc = "Bit 9 - Generic Payload Write Error Interrupt Enable"]
    #[inline]
    pub fn gpwreie(&mut self) -> _GPWREIEW {
        _GPWREIEW { w: self }
    }
    #[doc = "Bit 10 - Generic Payload Transmit Error Interrupt Enable"]
    #[inline]
    pub fn gptxeie(&mut self) -> _GPTXEIEW {
        _GPTXEIEW { w: self }
    }
    #[doc = "Bit 11 - Generic Payload Read Error Interrupt Enable"]
    #[inline]
    pub fn gprdeie(&mut self) -> _GPRDEIEW {
        _GPRDEIEW { w: self }
    }
    #[doc = "Bit 12 - Generic Payload Receive Error Interrupt Enable"]
    #[inline]
    pub fn gprxeie(&mut self) -> _GPRXEIEW {
        _GPRXEIEW { w: self }
    }
}
